...
class ChatThread:
    ...
    def get_messages(
        ...
        ----------
        limit : Optional[int]
            Maximum number of messages to return. If None, returns all.
        force_refresh : bool
...
class Chat:
    ...
    def __init__(
        ...
        ----------
        publication_id : Union[str, int]
            The publication ID to access the chat for.
        auth : SubstackAuth
            Authentication handler for API requests.
        """
    ...
    def get_threads(
        ...
        ----------
        limit : Optional[int]
            Maximum number of threads to return. If None, returns all.
        force_refresh : bool
            If True, fetch fresh data from the API.
